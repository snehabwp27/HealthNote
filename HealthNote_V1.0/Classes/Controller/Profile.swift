...
class Profile: UIViewController, ImagePickerDelegate, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, UITextFieldDelegate
{
    ...
    func textFieldShouldEndEditing(textField: UITextField) -> Bool
    {
        ...
        case 7: // email
            if Singleton.sharedInstance.isEmailAddressValid(textField.text!) == true
            {
                return true
            }else{
                return false
